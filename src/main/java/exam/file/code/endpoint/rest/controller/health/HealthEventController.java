package exam.file.code.endpoint.rest.controller.health;

import static exam.file.code.endpoint.rest.controller.health.PingController.KO;
import static exam.file.code.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import exam.file.code.PojaGenerated;
import exam.file.code.endpoint.event.EventProducer;
import exam.file.code.endpoint.event.model.DurablyFallibleUuidCreated1;
import exam.file.code.endpoint.event.model.UuidCreated;
import exam.file.code.repository.DummyUuidRepository;
import exam.file.code.repository.model.DummyUuid;

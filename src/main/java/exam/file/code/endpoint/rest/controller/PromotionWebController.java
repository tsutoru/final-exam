...
public class PromotionWebController {
  ...
  public ResponseEntity<byte[]> downloadDiplomes(@PathVariable UUID id) {

    List<MoyenneDto> diplomes = promotionService.listeDiplomes(id);

    StringBuilder csv = new StringBuilder();

    csv.append("ID Étudiant,Moyenne générale,Diplômé\n");
    ...
    return ResponseEntity.ok()
        .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=diplomes.csv")
